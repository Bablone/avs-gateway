...
1. What's your use case — what would this enable?
2. Would you expect this to be a YAML policy, a Python API, or both?
3. Is this blocking you right now, or a nice-to-have?
...
We use GitHub Discussions for questions and reserve Issues for bugs and feature requests. Could you repost this at https://github.com/avs-gateway/avs/discussions? That way more people can find and benefit from the answer.
...
1. What kind of agents are you building?
2. What actions do they take (file access, API calls, deployments)?
3. What's your biggest concern about agent safety right now?
...
4. **Landscape scan** (5 min) — Any competitor or ecosystem news?
...
- HN Search: https://hn.algolia.com/?q=AVS+Gateway
