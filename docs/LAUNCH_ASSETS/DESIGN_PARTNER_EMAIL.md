...
**Subject:** {{company_name}} — permission layer for your agent tools?
...
**Could we do a 15-minute call this week?** I'll share exactly where we fit in your toolchain — and where we don't.
...
**Worth a 15-minute conversation?** I'll show you the receipt format and policy structure — no product pitch.
...
**Got 15 minutes this week?** I'll send you a working example with your stack before we even talk.
